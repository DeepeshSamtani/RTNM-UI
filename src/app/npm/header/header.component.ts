...
menu:any;
 offset = this.configService.getConfiguration().offset;
  constructor(private commonParsingService:CommonParsingService , private configService:ConfigService,private router :Router,private localStorageService:LocalStorageService) { }
